...
final class BlurController {
    ...
    private boolean getBlurDisabledSetting() {
        boolean disableByDefault = SystemProperties.getBoolean("ro.surface_flinger.blur_disabled_by_default", true);
        int defaultValue = disableByDefault ? 1 : 0;

        return Settings.Global.getInt(mContext.getContentResolver(),
                Settings.Global.DISABLE_WINDOW_BLURS, defaultValue) == 1;
    }
}
